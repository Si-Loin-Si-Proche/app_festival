      ...
      >
        ...
        <View style={styles.planSection}>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              handlePress('geo:0,0?q=Allee+De+La+Ferme+77186+Noisiel')
            }
          >
            <ICONS.location size={14} color={COLORS.text} />
            <Typography variant="small" style={styles.underline}>
        ...
        <View style={styles.bottomSheet}>
          ...
          <View style={styles.sectionGap}>
            <Typography style={styles.subTitle}>• film à l'unité</Typography>
            {[
              ...
              <Typography key={i} variant="body">
                ...
                <Typography style={styles.priceDesc}>{item.t}</Typography>
              </Typography>
            ))}

            {/* correction tab */}
            <Typography style={{ ...styles.subTitle, marginTop: SPACING.m }}>
              • forfaits festival
            </Typography>
          ...
          <View style={styles.sectionGap}>
            <Typography style={styles.subTitle}>• billetterie</Typography>
...
const styles = StyleSheet.create({
  ...
  indent: { marginLeft: SPACING.m, fontFamily: FONTS.regular },
  email: {
